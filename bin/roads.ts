...
Promise.resolve()
  .then(async () => {
    const req = await fetch('https://raw.githubusercontent.com/decentraland/atlas-server/master/src/modules/map/data/specialTiles.json')
    ...
    const target = resolve(__dirname, '../src/entities/DeploymentTrack/data/roads.json')
