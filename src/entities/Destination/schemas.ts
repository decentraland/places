...
export const getDestinationsListQuerySchema = schema({
  ...
  properties: {
    ...
    with_live_events: {
      ...
      format: "boolean",
      description:
        "Include whether the destination has a live event (live property). Data is cached for 5 minutes.",
      nullable: true as any,
    },
    search: {
      type: "string",
    ...
    sdk: {
      type: "string",
      description:
        "Filter by SDK version (major version matching). Use '6' to match 6.x.x and null/legacy scenes, '7' to match 7.x.x versions.",
      nullable: true as any,
    },
  },
})
